...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "FELIZ SAN VALENTIN PEQUE";
...
function showCountdown() {
  ...
  function update() {
    ...
    container.innerHTML =
      `Tiempo de amistad aprox: <b>${days}</b> días<br>` +
      `Con fe llegamos: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
